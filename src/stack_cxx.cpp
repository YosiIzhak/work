...
, m_elements(new int[a_source.m_capacity])
, m_tos(a_source.m_tos)
{
    memcpy(m_elements, a_source.m_elements, sizeof(a_source.m_elements[0]) * a_source.m_tos);
    axioms();
    printf("pointer1: %p \npointer2: %p\n", (void*)m_elements, (void*)a_source.m_elements);
}
/*-------------- de-constructor -------------*/
Stack::~Stack()
{
